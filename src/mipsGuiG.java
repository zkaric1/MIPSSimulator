...
public class mipsGuiG {
	...
	void upisiuGUIreg() {
		for(int i = 0; i < 32; i++) {
			if( registers.read(i) != 0) {
				switch(i) {
				case 0: r0text.setText(String.valueOf(registers.read(i)));
				         break;
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 1048, 732);
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				postaviRegistre();
				textArea_1.append("Pokrenut mips\n");
				...
				textArea_1.update(textArea_1.getGraphics());
				for(int i = 0; i < listModel.size(); i++) 					
					textArea_1.append(listModel.get(i)+"\n");
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(lblInstrukcije, Alignment.LEADING)
								.addComponent(textPane, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE)
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(30)
							.addComponent(textArea_1, GroupLayout.PREFERRED_SIZE, 185, GroupLayout.PREFERRED_SIZE))
